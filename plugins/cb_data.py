...
# Ensure STRING_SESSION is present to avoid interactive login on Render
if not STRING_SESSION:
    raise ValueError("STRING_SESSION lama helin! Ku dar environment variable-ka STRING_SESSION.")

app = Client("JishuBotz", api_id=API_ID, api_hash=API_HASH, session_string=STRING_SESSION)

# --- The rest of your handlers and logic remain unchanged below ---
